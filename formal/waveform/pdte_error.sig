...
<wavelist version="3">
  ...
  <spacer/>
  <wave>
    <expr>i_rv_iommu_translation_wrapper.gen_pc_support.i_rv_iommu_tw_sv39x4_pc.dc_base.tc.pdtv</expr>
    <label/>
    <radix/>
  </wave>
  <wave>
  ...
  <group collapsed="false">
    ...
    <wave>
      <expr>i_rv_iommu_translation_wrapper.gen_pc_support.i_rv_iommu_tw_sv39x4_pc.i_rv_iommu_cdw_pc.cdw_implicit_access_o</expr>
      <label/>
      <radix/>
    </wave>
    <spacer/>
